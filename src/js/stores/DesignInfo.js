...
export const designs = [
  ...
  },
  {
    ...
    explanation: [
      ...
      "In my concept design, I used clean typographic elements and layout to give the designs a professional and contemporary feel,and created custom illustrations to bring an element of friendliness back to the brand. ",

      "To begin designing the brand elements, I started by doing rapid concept sketching for the RAILS logo and the illustrative elements, as I knew that they were both important components of the RAILS brief. This then developed into manipulating type, crafting illustrations and designing colour palettes in Illustrator. When I was happy with these elements I began working them into business card and website designs; finding the most appropriate and professional layouts for the brief. ",
    ],
    imageSet: [
      { image: railsartworkconcept },
      {
        image: railsbusinesscardconceptfront,
        desc: "concept designs for business cards for the rails brand",
      },
      {
      ...
      },
      {
        ...
        desc: "concept design for rails mobile website",
      },
      {
        image: railsmobileconcept,
        desc: "concept design for the Rails website",
      },
    ],
  },
  {
